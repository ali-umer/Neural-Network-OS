...
int main()                     //Start of Main
{
    ...
    config_file.open("//home//umair//Desktop//OS Project//config.txt");     //Opening Configuration File
    ...
    if(pid>=0){                 //If Fork Successful
        ...
        if(pid==0){                                    //If Child
            ...
            ifstream con_file("//home//umair//Desktop//OS Project//config.txt");            //Opening file to edit
            string line_temp;
            ...
            ofstream con_file_out("//home//umair//Desktop//OS Project//config.txt", std::ofstream::out);
